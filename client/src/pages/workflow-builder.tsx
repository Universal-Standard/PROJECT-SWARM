...
} from "@/components/workflow/connection-validator";
    ...
    <div className="h-screen w-full flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        >
          ...
          {/* Minimap */}
          <WorkflowMinimap position="bottom-right" visible={minimapEnabled} />
        ...
        <NodeContextMenu
          isLocked={!!selectedNode?.data?.locked}
          onDuplicate={selectedNode ? () => handleNodeDuplicate(selectedNode) : undefined}
          onDelete={selectedNode ? () => handleNodeDelete(selectedNode) : undefined}
          onCopy={selectedNode ? () => copy([selectedNode]) : undefined}
          onLockPosition={
            selectedNode
              ? () => handleNodeLock(selectedNode, !selectedNode.data?.locked)
              : undefined
          }
        >
          <WorkflowCanvas
        ...
        <Sheet open={showSearch} onOpenChange={setShowSearch}>
          <SheetContent side="left" className="w-[400px]">
            <SheetHeader>
              ...
              <SheetDescription>Find and filter workflow nodes</SheetDescription>
            </SheetHeader>
            <div className="mt-6">
              <NodeSearch
                nodes={nodes}
