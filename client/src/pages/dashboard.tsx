        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Design, deploy, and monitor intelligent agent workflows with enterprise-grade
              orchestration
            </p>
          </div>
                  ...
                  >
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={`/app/workflow-builder/${workflow.id}`}>
                          <Button
                            variant="ghost"
                            size="icon"
              ...
              {templatesLoading ? (
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-muted-foreground text-center">No templates available yet</p>
                  </CardContent>
                </Card>
              )}
            </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Explore our template library or chat with the AI assistant to design your first
                  agent swarm
                </p>
              </div>
