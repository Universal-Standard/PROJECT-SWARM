...
export class WebhookHandler {
  ...
  async processWebhook(
    ...
    try {
      ...
      await this.logWebhook(null, payload, headers, "failed", errorMessage);
  ...
  private async logWebhook(
    ...
    try {
      ...
      logger.error("Error logging webhook", logError);
    }
  }
  ...
  async testWebhook(
    ...
    return this.processWebhook(webhook.url, testPayload, {
